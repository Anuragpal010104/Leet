...
function Timer({}: Props) {
  ...
  return (
    <div>
      {showTimer ? (
        <div className="flex items-center space-x-2 bg-zinc-500 py-1.5 cursor-pointer rounded hover:bg-gray-300">
          <div>
            {formatTime(time)}
          </div>
        ...
        <div className="flex items-center p-1 h-8 hover:bg-slate-600 rounded cursor-pointer" onClick={()=>{
            setShowTimer(true);
            setTime(0);
        }}>
          <svg
